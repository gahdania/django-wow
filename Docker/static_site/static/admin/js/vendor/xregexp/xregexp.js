...
module.exports = function(XRegExp) {
    ...
    XRegExp.addToken(
        ...
        function(match, scope, flags) {
            ...
            var ERR_ASTRAL_IN_CLASS = 'Astral mode does not support Unicode tokens within character class';
            // Negated via \P{..} or \p{^..}
     ...
     *   character class and alternation, and should use surrogate pairs to represent astral code
...
fixed.replace = function(search, replacement) {
    ...
    if (isType(replacement, 'Function')) {
        ...
        result = nativ.replace.call(String(this), search, function() {
            ...
            // ES6 spec the context for replacement functions as `undefined`
